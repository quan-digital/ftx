...
class FtxClient:
    ...
    @authentication_required
    def get_conditional_orders(self, market: Optional[str] = None) -> List[dict]:
    ...
    def request_quote(self, fromCoin, toCoin, size) -> List[dict]:
        return self._post(
            "otc/quotes", {"fromCoin": fromCoin, "toCoin": toCoin, "size": size}
        )
    ...
    def request_withdrawal(
        ...
        return self._post(
            "wallet/withdrawals", {"coin": coin, "size": size, "address": address}
        )
